...
/*
  ...
  create table if not exists public.app_institutional_records (
    ...
    vacation_type text,
    license_type text,
    leave_status text, -- Para alunos, este campo armazena Deficiência (Sim/Não). Para servidores, mantém Afastamento.
  ...
  -- Para políticas de segurança completas, aplique o arquivo:
