...
// A chave abaixo é a anon/public key do Supabase. Ela pode ficar no front-end,
// mas a proteção real precisa estar nas policies de RLS do banco.
...
/*
  ...
  alter table public.app_institutional_records enable row level security;
  ...
  create policy "auth manage institutional_records" on public.app_institutional_records for all to authenticated using (true) with check (true);
*/
...
export const DB_TABLES = {
  ...
  users: 'app_user_profiles',
  attendance: 'app_daily_attendance'
};
