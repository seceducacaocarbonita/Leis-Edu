  ...
  const html = `
    ...
    <head>
      ...
      <style>
        * { box-sizing: border-box; }
        ...
        .header {
          border-bottom: 3px solid #1646b3;
          padding-bottom: 12px;
          margin-bottom: 18px;
        }
        .header h1 {
    ...
    <body>
      ...
      <div class="record-title">
        <h2>${escapeHtml(record.name)}</h2>
        <p>${escapeHtml(personTypeLabel)}</p>
      </div>
      ...
      <section class="section">
        ...
        <div class="section-grid">
          ...
          <div class="field full">
            ...
            <div class="value">${escapeHtml(personTypeLabel)}</div>
          </div>
          ${supportTeacher ? `
          <div class="field full support-print">
            <span class="label">Professor de Apoio</span>
            <div class="value">${escapeHtml(supportTeacher)}</div>
          </div>` : ""}
          ${!isStudentRecord ? `
          <div class="field">
            <span class="label">CPF</span>
            <div class="value">${escapeHtml(record.cpf || "-")}</div>
          </div>` : ""}
          <div class="field">
            <span class="label">Telefone</span>
            <div class="value">${escapeHtml(record.phone || "-")}</div>
          </div>
          ${!isStudentRecord ? `
          <div class="field">
            <span class="label">E-mail</span>
            <div class="value">${escapeHtml(record.email || "-")}</div>
          </div>` : ""}
          <div class="field">
          ...
          ${!isStudentRecord ? `
          <div class="field">
            <span class="label">Férias</span>
            <div class="value">${escapeHtml(formatInstitutionVacation(record.vacation))}</div>
          </div>
          <div class="field">
            <span class="label">Licenças</span>
            <div class="value">${escapeHtml(record.license || "-")}</div>
          </div>
          <div class="field">
            <span class="label">Afastamento</span>
            <div class="value">${escapeHtml(formatInstitutionLeaveStatus(record.leaveStatus))}</div>
          </div>
          <div class="field">
            <span class="label">Documento de afastamento</span>
            <div class="value">${escapeHtml(leaveDocumentLabel)}</div>
          </div>` : ""}
        </div>
      </section>

      <section class="section">
        <h3 class="section-title">Dados Contratuais</h3>
        <div class="divider"></div>
        <div class="section-grid">
          <div class="field">
            <span class="label">Função / vínculo</span>
            <div class="value">${escapeHtml(record.role || "-")}</div>
          </div>
          <div class="field">
            <span class="label">Cargo</span>
            <div class="value">${escapeHtml(record.position || "-")}</div>
          </div>
          <div class="field">
            <span class="label">Escola</span>
            <div class="value">${escapeHtml(record.department || "-")}</div>
          </div>
          <div class="field">
            <span class="label">Situação</span>
            <div class="value">${escapeHtml(record.status || "-")}</div>
          </div>
        </div>
      </section>
      ...
      <section class="section">
        ...
        <div class="section-grid">
          <div class="field">
            ...
            <div class="value">${escapeHtml(record.formation || "-")}</div>
          </div>
          <div class="field">
            <span class="label">Graduação</span>
            <div class="value">${escapeHtml(record.graduation || "-")}</div>
          </div>
          <div class="field">
            <span class="label">Especialização</span>
            <div class="value">${escapeHtml(record.specialization || "-")}</div>
          </div>
          <div class="field">
            <span class="label">Data de conclusão</span>
            <div class="value">${escapeHtml(record.conclusionDate ? formatDate(record.conclusionDate) : "-")}</div>
          </div>
        </div>
      </section>` : ""}
    </body>
...
async function switchAdminTab(tab) {
  ...
  if (targetTab === "presence") renderPresencePanel();
...
function getPresenceEligibleRecords() {
  return institutionalRecords
    .map(normalizeInstitutionalRecord)
    .filter(record => record.personType !== "Aluno")
    .sort((a, b) => a.name.localeCompare(b.name, "pt-BR"));
}
...
function getPresenceFilteredRecords(records = getPresenceEligibleRecords()) {
  ...
  return records.filter(record => (record.department || "").trim() === schoolFilter);
}
...
function calculateDailyAttendanceSummary(entry, monthKey) {
  ...
  for (let day = 1; day <= totalDays; day += 1) {
    ...
    if (status === "A") justified += 1;
    if (status === "AJ") unjustified += 1;
  }
