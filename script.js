  ...
  safeRenderAdminSection(() => renderAdminStats(), () => {
    if (els.adminStatsGrid) {
      els.adminStatsGrid.innerHTML = [
        ...
        statCard("Funcionários cadastrados", 0),
...
function applySettingsToUI() {
  const portalTitle = settingsData.portalTitle || "Portal de Gestão Educacional";
  const portalSubtitle = settingsData.portalSubtitle || "Plataforma institucional para consulta, organização e acompanhamento de alunos, funcionários, documentos, leis e indicadores da rede educacional.";
...
function renderPublicStats() {
  ...
  els.statsGrid.innerHTML = `
    ...
    ${statCard("Funcionários", institutionalSummary.staff)}
    ${statCard("Alunos", institutionalSummary.students)}
  `;
}
...
function createDefaultSettings() {
  return {
    ...
    footerLabel: "Secretaria de Educação",
    bannerEnabled: true,
