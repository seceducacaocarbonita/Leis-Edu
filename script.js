  ...
  const html = `
    ...
    <body>
      ...
      <div class="grid">
        ...
        <div class="item"><strong>Formação</strong>${escapeHtml(record.formation || "-")}</div>
        <div class="item"><strong>Ano de conclusão</strong>${escapeHtml(record.conclusionDate ? formatDate(record.conclusionDate) : "-")}</div>
        <div class="item"><strong>Graduação</strong>${escapeHtml(record.graduation || "-")}</div>
        <div class="item"><strong>Especialização</strong>${escapeHtml(record.specialization || "-")}</div>
