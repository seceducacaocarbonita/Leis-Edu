      ...
      <summary class="presence-person-summary">
        ...
        <div class="presence-person-summary-side">
          <div class="presence-person-summary-stats">
            ...
            <span class="presence-mini-stat"><strong>A</strong> ${summary.unjustified}</span>
            <span class="presence-mini-stat"><strong>AJ</strong> ${summary.justified}</span>
...
async function handleSaveInstitutionalRecord(event, mode = "staff") {
  ...
  renderPublicStudentsDonut();
  renderPublicStaffDonut();
  if (currentTab === "presence") renderPresencePanel();
}
