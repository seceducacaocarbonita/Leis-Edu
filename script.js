...
function mapElements() {
  [
    ...
    "presenceMonthPicker", "fillPresenceWorkdaysBtn", "savePresenceBtn", "presenceMonthInfo", "presenceSummaryGrid", "presenceTableBody",
  ...
  els.presenceTableBody.innerHTML = people.map(person => {
    ...
    return `
      <tr data-person-id="${person.id}">
        ...
        <td>${getAttendanceRateBadge(rate)}</td>
...
function applyDefaultPresenceWorkdays() {
  ...
  showToast("Dias previstos preenchidos com 22 para o mês selecionado.");
}
