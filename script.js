...
async function loadData(options = {}) {
  ...
  try {
    ...
    settingsData = settingsData && Object.keys(settingsData).length ? settingsData : createDefaultSettings();
...
function applySettingsToUI() {
  ...
  const portalLabel = settingsData.footerLabel || settingsData.orgName || "Secretaria Municipal de Educação";

  document.title = portalTitle;
  setText(els.orgNameTop, settingsData.orgName);
  setText(els.portalLabelTop, portalLabel);
...
async function handleSaveSettings(event) {
  ...
  if (els.orgNameInput) settingsData.orgName = els.orgNameInput.value.trim() || settingsData.orgName;
  ...
  settingsData.footerLabel = settingsData.orgName || "Secretaria Municipal de Educação";
        ...
        <main class="sheet">
          ...
          <header class="header">
            <div class="brand">
              ...
              <div>
                <h1>${escapeHtml(settingsData.orgName || "Secretaria Municipal de Educação")}</h1>
...
function importJsonBackup(event) {
  ...
  reader.onload = () => {
    try {
      ...
      settingsData = { ...createDefaultSettings(), ...(data.settings || {}) };
