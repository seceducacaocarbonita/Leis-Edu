...
function mapElements() {
  [
    ...
    "studentInstitutionDepartment", "studentInstitutionPosition", "studentInstitutionStatus", "studentInstitutionSupportTeacher", "studentInstitutionCpf",
    ...
    "detailInstitutionName", "detailInstitutionType", "detailInstitutionSupportTeacherItem", "detailInstitutionSupportTeacher", "detailInstitutionRole", "detailInstitutionDepartment", "detailInstitutionPosition", "detailInstitutionFormation", "detailInstitutionConclusionDate",
...
function getFilteredInstitutionalRecords() {
  ...
  return [...institutionalRecords]
    ...
    .filter(record => {
      ...
      return matchesTerm && matchesType && matchesStatus && matchesSchoolScope;
    })
    .sort((a, b) => a.name.localeCompare(b.name, "pt-BR"));
}
...
function renderInstitutionalTable() {
  ...
  els.institutionRecordsBody.innerHTML = rows.length ? rows.map(record => {
    ...
    return `
    <tr class="${supportTeacher ? "student-has-support" : ""}">
...
function renderInstitutionalDetail(recordId) {
  ...
  const supportTeacher = getStudentSupportTeacher(record);
  setStudentDetailFieldsVisibility(record.personType === "Aluno");
