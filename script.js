...
export async function saveDocument(formData) {
  const payload = {
    ...
    protocol: crypto.randomUUID(),
    document_type: formData.document_type,
    category_id: formData.category_id,
    administrative_sphere: formData.administrative_sphere,
    law_or_document_number: formData.law_or_document_number || null,
    year: Number(formData.year),
    issuing_body: formData.issuing_body,
    jurisdiction_state: formData.jurisdiction_state || null,
    jurisdiction_city: formData.jurisdiction_city || null,
