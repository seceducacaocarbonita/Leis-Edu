...
const USER_ACCESS_BY_EMAIL = {
  ...
  "escoladaestiva2@gmail.com": {
    role: "diretor",
    school: "Escola Municipal Nucléo Estiva"
  },
...
function getScopedSchoolVariants(school = adminUserSchool) {
  ...
  const aliasGroups = [
    ["escola municipal nucleo estiva", [
      "Escola Municipal Nucléo Estiva",
      "Escola Municipal Núcleo Estiva",
      "Escola Municipal Nucléo da Estiva",
      "Escola Municipal Nuclêo da Estiva",
      "Escola Municipal Nucléo Estiva"
    ]],
...
function renderInstitutionalTable() {
  ...
  els.institutionRecordsBody.innerHTML = rows.length ? rows.map(record => {
    ...
    <tr class="${supportTeacher ? "student-has-support" : ""}">
      ...
      <td class="institution-cpf-cell">${escapeHtml(record.cpf || "-")}</td>
