...
function getProfessionalPortalTitle(value = "") {
  ...
  if (!current || current === "Portal de Gestão Educacional") {
    return "Portal Oficial da Secretaria Municipal de Educação";
  }
  return current;
}
...
function getProfessionalPortalSubtitle(value = "") {
  ...
  if (!current || current === "Plataforma institucional para consulta, organização e acompanhamento de alunos, funcionários, documentos, leis e indicadores da rede educacional.") {
    return "Consulte documentos oficiais, comunicados, indicadores públicos e informações institucionais da rede municipal de ensino.";
  }
  return current;
}
...
function fillSettingsForm() {
  ...
  setValue(els.portalTitleInput, settingsData.portalTitle || "Portal de Gestão Educacional");
...
async function handleSaveSettings(event) {
  ...
  if (els.portalTitleInput) settingsData.portalTitle = els.portalTitleInput.value.trim() || settingsData.portalTitle || "Portal de Gestão Educacional";
          ...
          <header class="header">
            <div class="brand">
              ...
              <div>
                ...
                <p>${escapeHtml(settingsData.portalTitle || "Portal de Gestão Educacional")} • Ficha individual do aluno</p>
              </div>
            </div>
      ...
      <main class="sheet">
        ...
        <header class="header">
          <div class="brand">
            ...
            <div>
              <h1>${escapeHtml(settingsData.orgName || "Secretaria Municipal de Educação")}</h1>
              <p>${escapeHtml(settingsData.portalTitle || "Portal de Gestão Educacional")} • Ficha individual de ${escapeHtml(professionalLabel.toLowerCase())}</p>
            </div>
          </div>
          <div class="header-badge">
            <span>Documento institucional</span>
...
function createDefaultSettings() {
  return {
    portalTitle: "Portal Oficial da Secretaria Municipal de Educação",
